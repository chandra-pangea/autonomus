...
4. **Bump version** in `metadata.json`, set `status: Active`

5. **Show only the changed section(s)** — not the whole BRD again unless user asks

6. **Continue waiting** for more changes
